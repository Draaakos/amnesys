...
function FocusCharacter(a_CharacterNumber, a_CharacterName, a_NumberOfCharacters)
{
  ...
  */
  ...
  document.getElementsByName('selectedcharacter')[0].value = a_CharacterName;
}
...
{
  a_Button.src = IMAGES + "/account/play-button-over.gif";
}

function OutMiniButton(a_Button) 
{
  a_Button.src = IMAGES + "/account/play-button.gif";
}