...
function LoadLoginBox()
{
  if(loginStatus == "false") {
    // ### temporary for spring-update ###
    /*
    document.getElementById('PlayNowContainer').childNodes[0].childNodes[1].childNodes[1].src = IMAGES + "/global/buttons/mediumbutton_playnow.png";
    */
    document.getElementById('PlayNowContainer').childNodes[0].childNodes[1].childNodes[1].src = IMAGES + "/global/buttons/mediumbutton_login.png";
    document.getElementById('LoginstatusText_1').style.backgroundImage = "url('" + IMAGES + "/global/loginbox/loginbox-font-create-account.gif')";
    document.getElementById('LoginstatusText_2').style.backgroundImage = "url('" + IMAGES + "/global/loginbox/loginbox-font-create-account-over.gif')";
  } else {
    document.getElementById('PlayNowContainer').childNodes[0].childNodes[1].childNodes[1].src = IMAGES + "/global/buttons/mediumbutton_myaccount.png";
    document.getElementById('LoginstatusText_1').style.backgroundImage = "url('" + IMAGES + "/global/loginbox/loginbox-font-logout.gif')";
    document.getElementById('LoginstatusText_2').style.backgroundImage = "url('" + IMAGES + "/global/loginbox/loginbox-font-logout-over.gif')";
  }
}
...
{
  if(loginStatus == "false") {
    window.location = LINK_ACCOUNT + "/index.php/account";
  } else {
    window.location = LINK_ACCOUNT + "/index.php/account";
  }
}
function LoginstatusTextAction(source) {
  if(loginStatus == "false") {
    window.location = LINK_ACCOUNT + "/index.php/account/create";
  } else {
    window.location = LINK_ACCOUNT + "/index.php/account/logout";
  }
}
...
function LoadMenu()
{
  ...
  if(self.name.lastIndexOf("&") == -1) {
    self.name = "news=1&community=0&forum=0&account=0&shops=0&";
  }
  FillMenuArray();
  InitializeMenu();
}
