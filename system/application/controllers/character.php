...
class Character extends Controller {
	...
	function create_character() {
		...
		if($_POST) {
			$_POST['name'] = ucwords(strtolower(decodeString($_POST['name'])));
			$this->form_validation->set_rules('name', 'Player Name', "required|min_length[3]|max_length[20]|alpha_space|callback__playerExists|callback__validName");
